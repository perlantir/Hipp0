    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-primary)] px-4 py-12">
      <div className="w-full max-w-2xl">
        ...
        <div className="flex items-center justify-center gap-2 mb-10">
          ...
          <span className="font-semibold text-lg tracking-tight">Hipp0</span>
        </div>
          ...
          {step === 0 && (
            <div className="text-center">
              ...
              <p className="text-sm text-[var(--text-secondary)] leading-relaxed mb-8 max-w-md mx-auto">
                Hipp0 captures every architectural choice, product decision, and trade-off your
                ...
                <div className="grid grid-cols-1 gap-3">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        'Paste a conversation and Hipp0 will extract decisions automatically.',
                    },
                    {
